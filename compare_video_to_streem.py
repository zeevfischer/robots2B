...
# Function to convert string representation of corners to numpy array
    ...
    for i in range(len(current_info)):
        for j in range(len(reference_info)):
            ...
            if what_i_see == what_we_reference:
                ...
                if abs(corner_diff_x) > 100:  # Arbitrary threshold for corner X difference
                    if corner_diff_x > 0:
                        corner_command_x = "left"
                    else:
                        corner_command_x = "right"

                if abs(corner_diff_y) > 100:  # Arbitrary threshold for corner Y difference
                    if corner_diff_y > 0:
                        corner_command_y = "up"
                    else:
